...
import com.example.mesajlasmauygulamasibitirme.databinding.ActivityOtpactivityBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.button.setOnClickListener {
            if(binding.otp.text!!.isEmpty())
            {
                ...
                dialog.show()
                var credential=PhoneAuthProvider.getCredential(verificationId,binding.otp.text!!.toString())
